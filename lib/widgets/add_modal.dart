  ...
  Future<void> _fetchCategories() async {
    try {
      ...
      setState(() {
        ...
        _selectedCategoryId = _categories.isNotEmpty ? _categories[0].id.toString() : null;
            ...
            child: ElevatedButton(
              onPressed: _isSaving ? null : () async {
                ...
                try {
                  ...
                  await _controller.createHabit(_nameController.text.trim(), int.parse(_selectedCategoryId!));
